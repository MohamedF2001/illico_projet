...
class PointAdresseModel extends PointAdresse {
  ...
  factory PointAdresseModel.fromJson(Map<String, dynamic> j) =>
      _$PointAdresseModelFromJson(j);
...
class LivraisonModel extends LivraisonEntity {
  ...
  const LivraisonModel({
    ...
    this.dateLivraison,
          ...
          vehicule: vehicule,
          mode: mode,
          pointIllico: pointIllico,
          statut: statut,
          prixEstime: prixEstime,
          prixFinal: prixFinal,
          modePaiement: modePaiement,
          otpValide: otpValide,
          otpLivraison: otpLivraison,
          otpRetrait: otpRetrait,
          natureColis: natureColis,
          preuveLivraisonUrl: preuveLivraisonUrl,
  ...
  factory LivraisonModel.fromJson(Map<String, dynamic> j) =>
      _$LivraisonModelFromJson(j);
